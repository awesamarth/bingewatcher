...
export default async function TitlePage({ params, searchParams }: { params: Promise<{ type: string; id: string }>; searchParams: Promise<{ season?: string }> }) {
    ...
    <main className="min-h-screen bg-canvas">
      ...
      <header className="relative flex min-h-[78svh] items-end overflow-x-clip px-5 pb-14 sm:px-[8vw] sm:pb-20">
        ...
        <div className="relative z-2 max-w-210">
          <Link className="mb-8 inline-flex items-center gap-2 text-xs text-[#c4bdb7] hover:text-white" href="/explore"><ArrowLeft size={15} /> Explore</Link>
